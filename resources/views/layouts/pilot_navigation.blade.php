<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <!-- <a href="{{ route('pilot.pilot_dashboard') }}">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <!-- Authentication -->
                        <form method="POST" action="{{ route('pilot.logout') }}">
                            @csrf

                            <x-dropdown-link :href="route('pilot.logout')" onclick="event.preventDefault();
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('pilot.pilot_dashboard')" :active="request()->routeIs('pilot.pilot_dashboard')">
                {{ __('Dashboard') }}
